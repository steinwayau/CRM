...
export const STAFF_DATABASE: StaffMember[] = [
  ...
  { name: "Abbey Landgren", isActive: true, role: "Staff", email: "abbey@epgpianos.com.au" },
  { name: "Alexa Curtis", isActive: true, role: "Staff" },
  { name: "Angela Liu", isActive: true, role: "Staff" },
  { name: "Chris", isActive: true, role: "Staff" },
  { name: "Daryl", isActive: true, role: "Staff" },
  { name: "Jeremy", isActive: true, role: "Staff" },
  { name: "Jessica Herz", isActive: true, role: "Staff" },
  { name: "Lucy", isActive: true, role: "Staff" },
  { name: "Mark", isActive: true, role: "Staff" },
  { name: "Sargoon", isActive: true, role: "Staff" },
  { name: "Teresa", isActive: true, role: "Staff" },
  ...
  { name: "June", isActive: false, role: "Former Staff" },
  ...
  { name: "Mike", isActive: false, role: "Former Staff" },
